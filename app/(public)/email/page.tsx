...
export default function SignUpPage({ searchParams }: { searchParams: { email?: string } }) {
      ...
      <div className="flex flex-col items-center justify-center text-center">
        <h1 className="text-black text-[24px] md:text-[32px] lg:text-[40px] mb-[10px] font-bold">Check your email</h1>
        <p className="max-w-[450px] text-center text-gray-700 text-[16px] md:text-[18px] lg:text-[20px]">Follow the link in the email we sent to (email). The email can take up to 1 minute to arrive.
        </p>
        <div className="mb-[-40px] mt-[-20px] flex items-center justify-center w-[300px] h-[300px] md:w-[400px] md:h-[400px]">
