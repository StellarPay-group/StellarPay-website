    ...
    <main className="bg-[#ffffff]">
      ...
      <motion.section
          ...
          >
            ...
            <div className="border-1 shadow-md border-gray-300 bg-white py-1 w-[140px] rounded-[30px] mb-6">
            <h2 className="text-[18px] font-semibold text-black text-center">Meet LinQ</h2>
            </div>
            <div>
              <h1 className="text-center leading-[75px] text-black font-semibold text-[65px] mb-6">The highest standard in account linking</h1>
            </div>
            <div>
...
Unify your access to bank and mobile money accounts through a single API.
      ...
      <motion.section
            className="mt-20 flex flex-col items-start pt-0 mb-30 px-8 md:px-6 bg-[#f7f7f7] bg-cover"
            ref={heroAnimation.ref}
            initial={heroAnimation.initial}
            animate={heroAnimation.animate}
            transition={heroAnimation.transition}
