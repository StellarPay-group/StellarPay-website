...
export default function HomePage() {
  ...
  const ButtonGroup = ({ next, previous, carouselState }: ArrowProps) => {
  ...
  return (
    ...
    <main>
      ...
      >
        <motion.div 
          className="aspect-[1098/269] max-w-[1098px] w-full flex items-center justify-center mx-auto"
        ...
        <motion.p 
          className="text-lg md:text-[24px] font-[600] text-gray-700 mb-10 max-w-3xl mx-auto"
        ...
        <motion.div 
          className="flex flex-col md:flex-row gap-4 items-center justify-center mt-4 mb-12"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <Image src="/images/appleStore.png" alt="apple" width={150} height={70} className="mr-5" style={{height: 'auto'}} />
        </a>
      ...
      {/* === StellarPay Section === */}
      <motion.section 
        className="bg-white py-12 pb-1 px-4"
        initial={{ opacity: 0 }}
      ...
      {/* One app section */}
      <motion.section 
        className="bg-white px-12 py-5 flex items-center justify-center"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
      ...
      {/* Security Section */}
      <motion.section 
        className="w-full px-4 sm:px-8 md:px-12 lg:px-[112px] xl:px-[120px] 2xl:px-[128px] py-20"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
      >
        <div className="aspect-[1225/664] max-w-[1470px] w-full mx-auto rounded-[60px] bg-blue-50 p-8 py-20 flex flex-col md:flex-row items-start justify-between gap-10">
          <motion.div 
            className="pl-8 flex-1 max-w-lg"
            initial={{ opacity: 0, x: -50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            viewport={{ once: true }}
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <Image src="/images/security-illustration.png" alt="Security Illustration" width={310} height={449} className="shadow-lg" loading="lazy"
            />
          </motion.div>
        </div>
      </motion.section>
      ...
      <motion.section 
        className="flex flex-col items-center justify-center px-4 md:px-0 py-4 md:py-4 bg-white text-center"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
      ...
      >
        ...
        <Image src="/images/carousel_7.png" alt="" fill style={{objectFit: 'cover'}} loading="lazy"/>
          </div>
          <div className="relative w-[400px] h-[600px] overflow-hidden rounded-lg">
        <Image src="/images/carousel_2.png" alt="" fill style={{objectFit: 'cover'}} loading="lazy"/>
          </div>
          <div className="relative w-[400px] h-[600px] overflow-hidden rounded-lg">
        <Image src="/images/carousel_3.png" alt="" fill style={{objectFit: 'cover'}} loading="lazy"/>
          </div>
          <div className="relative w-[400px] h-[600px] overflow-hidden rounded-lg">
        <Image src="/images/carousel_6.png" alt="" fill style={{objectFit: 'cover'}} loading="lazy"/>
          </div>
          <div className="relative w-[400px] h-[600px] overflow-hidden rounded-lg">
        <Image src="/images/carousel_5.png" alt="" fill style={{objectFit: 'cover'}} loading="lazy"/>
          </div>
      </Carousel>
        </Suspense>
        </motion.div>
      ...
      {/* Footer */}
      <motion.footer 
        className="bg-[#ffffff] text-[#000000] px-6 py-35"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
